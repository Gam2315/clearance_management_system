    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item active">Create New User Account</span>
                </nav>
            </div>
        </div>
        <!-- Content goes Here -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-25">
                    <form method="POST" action="{{route('admin.users.store_new_user')}}" enctype="multipart/form-data">
                        @csrf
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <select id="role" name="role" class="form-control">
                                    ...
                                    <option value="adviser" {{ old('role') == 'adviser' ? 'selected' : '' }}>Schoolwide Adviser</option>
