...
class ClearanceController extends Controller
{
    public function getClearance()
    {
        ...
        return view('admin.clearance.list-of-clearance', compact('clearances', 'departments'));
    }
    ...
    public function listClearance(Request $request)
    {
        ...
        if (in_array($employeeDepartmentId, $restrictedDepartments)) {
            $clearances = Clearance::where('department_id', $employeeDepartmentId)
                                  ->with('academicYear', 'student', 'department')
                                  ->get();
        } else {
            // For other departments (like Library, SBAHM), show all students
            $clearances = Clearance::with('academicYear', 'student', 'department')->get();
        }
