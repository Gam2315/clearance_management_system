                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="student-container">
                            ...
                            <div class="header-section">
                                <a class="back-btn" href="{{route('adviser.clearance.clearance-tap-id')}}">
                            ...
                            <div class="p-4">
                                ...
                                @if(in_array($userDepartmentCode, $restrictedDepartments) &&
                                auth()->user()->department_id !== $student->department_id)
                                <!-- If the logged-in user belongs to a restricted department and the student is from a different department -->
                                <div class="status-card alert alert-warning">
                                    <div class="d-flex align-items-center">
                                        <i class="fas fa-exclamation-triangle me-2"></i>
                                        <span>You cannot clear this student as they belong to a different department.</span>
                                    </div>
                                </div>
                                @else
                                ...
                                <form method="POST" action="{{ route('adviser.clearance-status.store') }}" id="clearanceForm">
                                    @csrf
                                        ...
                                        if ($clearance && $clearance->statuses) {
                                            foreach ($clearance->statuses as $status) {
                                                if (
                                                    ...
                                                    $status->approver_role == auth()->user()->role
                                                ) {
                                    ...
                                    @if ($existingStatus->approved_by == auth()->id())
                                    <div class="status-card alert-success">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-check-circle me-2"></i>
                                            <span>You already cleared this student.</span>
                                        </div>
                                    </div>
                                    @else
                                    <div class="status-card alert-warning">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-exclamation-triangle me-2"></i>
                                            <span>Student has already been cleared by another user in your department.</span>
                                        </div>
                                    </div>
                                    @endif
                                    @else
