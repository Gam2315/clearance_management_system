...
class DeanClearanceController extends Controller
{
    ...
    {
        return view('dean.reports.automatic-clearance');
    }
    ...
    public function DeanlistClearance(Request $request)
    {
        $user = Auth::user();
        ...
        $departments = Department::all();
         ...
         return view('dean.clearance.list-of-clearance', compact('clearances', 'departments'));
    }
