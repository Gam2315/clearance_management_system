                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="student-container">
                            ...
                            <div class="header-section">
                                <a class="back-btn" href="{{route('dean.clearance.clearance-tap-id')}}">
                            ...
                            <div class="p-4">
                                ...
                                <form method="POST" action="{{ route('dean.clearance-status.store') }}" id="clearanceForm">
                                    @csrf
                                    ...
                                    if (!isset($existingStatus)) {
                                        ...
                                        if ($clearance && $clearance->statuses) {
                                            foreach ($clearance->statuses as $status) {
                                                if ($status->department_id == auth()->user()->department_id) {
                                                    $existingStatus = $status; // Store the entire status object
                                                    break;
                                                }
                                            }
                                        }
                                    ...
                                    <div class="status-card alert-success">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span>This student has already been cleared by your department.</span>
                                        </div>
                                    </div>
                                    @else
                                    <!-- Form Section -->
