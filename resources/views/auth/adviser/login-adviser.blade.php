                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="m-l-auto col-md-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="m-t-20">PSG-Adviser Login</h2>
                                    <p class="m-b-30">To access the PSG-Adviser panel, please login using your PSG-Adviser credentials.</p>
                                    <form method="POST" action="{{ route('auth.adviser.login') }}">
                                        @csrf
