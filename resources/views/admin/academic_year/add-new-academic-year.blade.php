...
<div class="page-container">
    ...
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Create Academic Year</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item active">Add New Academic Year</span>
                </nav>
            </div>
        </div>
        <!-- Content goes Here -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-25">
                    <form method="POST" action="{{route('admin.academic_year.store_new_academic_year')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="academic_year" class="col-sm-2 col-form-label">Academic Year</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" id="academic_year" name="academic_year"
                                    placeholder="Enter A.Y." value="{{ old('academic_year') }}">
                            </div>
                            @error('academic_year')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <button type="submit" class="btn btn-success btn-tone m-r-5">Add Academic Year</button>
