        ...
        <div class="container-fluid">
            <div class="d-flex full-height p-v-20 flex-column justify-content-between">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="m-l-auto col-md-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="m-t-20">Student Login</h2>
                                    <p class="m-b-30">To access the student panel, please login using your student credentials.</p>
                                    <form method="POST" action="{{ route('auth.student.login') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="login">Student ID:</label>
                                            <div class="input-affix">
                                                <i class="prefix-icon anticon anticon-user"></i>
                                                <input type="text" name="login" class="form-control" id="login" required
                                                    autofocus autocomplete="username" placeholder="Student ID">
                                            </div>
                                            @error('login')
                ...
                <div class="d-none d-md-flex  p-h-40 justify-content-between">
                    <span class="">Copyright © {{now()->year }} - {{now()->addYear()->year}} St. Paul University Philippines</span>
