...
<head>
    ...
    <!-- Custom header css -->
    <link href="{{asset('assets/css/custom-header.css')}}" rel="stylesheet">

</head>

<body>
    <div class="app is-dark-green">
        <div class="layout">
            <!-- Header START -->
            <div class="header">
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            ...
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                ...
                                <a href="{{ route('adviser.account_settings') }}"
                                ...
                                <!-- Logout -->
                                <form id="logout-form" action="{{ route('adviser.logout') }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                </form>
                                <a href="javascript:void(0);"
            ...
            <!-- Side Nav START -->
            @include('adviser.layout.sidebar');
            <!-- Side Nav END -->
    ...
    @include('adviser.layout.scripts');
