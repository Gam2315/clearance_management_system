    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-25">
                    <form method="POST" action="{{route('admin.users.update_officer_user_account', $user->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <select id="program" name="program" class="form-control">
                                    ...
                                    @foreach($course as $courses)
                                        <option value="{{ $courses->id }}"
                                            {{ old('course_id', $user->course_id ?? '') == $courses->id ? 'selected' : '' }}>
                                            {{ $courses->course_name }}
                                        </option>
                                    @endforeach
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select id="dsn_id" name="dsn_id" class="form-control">
                                    ...
                                    <option value="{{ $designations->id }}" {{ old('designation_id', $user->
                                        designation_id ?? '') == $designations->id ? 'selected' : '' }}>
                                ...
                                <select id="position_id" name="position_id" class="form-control">
                                    ...
                                    @foreach($position as $positions)
                                        <option value="{{ $positions->id }}"
                                            {{ old('position_id', $user->position_id ?? '') == $positions->id ? 'selected' : '' }}>
