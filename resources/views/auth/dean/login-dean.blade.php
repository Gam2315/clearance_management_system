                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="m-l-auto col-md-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="m-t-20">Department Head Login</h2>
                                    <p class="m-b-30">To access the Department Head panel, please login using your Department Head credentials.</p>
                                    <form method="POST" action="{{ route('auth.dean.login') }}">
                                        @csrf
