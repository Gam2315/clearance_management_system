...
<div class="page-container">
    ...
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Create Department Information</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item active">Add New Department</span>
                </nav>
            </div>
        </div>
        <!-- Content goes Here -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-25">
                    <form method="POST" action="{{route('admin.department.store_new_department')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="department_head" name="department_head"
                                    placeholder="Enter Department Head" value="{{ old('department_head') }}">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <button type="submit" class="btn btn-success btn-tone m-r-5">Add Department
                                    Information</button>
                            </div>
                        </div>
                    </form>
