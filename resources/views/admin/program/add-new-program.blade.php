...
<div class="page-container">
    ...
    <div class="main-content">
        <div class="page-header">
            <h2 class="header-title">Create Program Information</h2>
            <div class="header-sub-title">
                <nav class="breadcrumb breadcrumb-dash">
                    ...
                    <span class="breadcrumb-item active">Add New Program</span>
                </nav>
            </div>
        </div>
        <!-- Content goes Here -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="m-t-25">
                    <form method="POST" action="{{route('program.store_new_program')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="program_code" name="program_code"
                                    placeholder="Enter Program Code" value="{{ old('program_code') }}">
                            </div>
                            @error('program_code')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <button type="submit" class="btn btn-success btn-tone m-r-5">Add Program
                                    Information</button>
                            </div>
                        </div>
                    </form>
