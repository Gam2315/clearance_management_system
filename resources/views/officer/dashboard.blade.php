                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <a href="{{route('officer.student.list-of-students')}}" class="btn btn-info btn-sm w-100">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <a href="{{route('officer.clearance.clearance-tap-id')}}" class="btn btn-warning btn-sm w-100">
