                        ...
                        <div class="m-l-auto col-md-5">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('auth.student.store') }}"
                                        ...
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="employee_id">Student ID:</label>
                                        ...
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="lastname">Program:</label>
                                            <select name="course" required id="course" class="form-control">
                                                ...
                                                <option value="BSEnSE">BS in Environmental and Sanitary Engineering
                                                </option>
                                        ...
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="lastname">Year:</label>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex align-items-center justify-content-between p-t-15">
                                                ...
                                                <button class="btn btn-primary">Register As Student</button>
